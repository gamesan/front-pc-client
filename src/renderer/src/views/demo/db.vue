 ...
 * @LastEditors: yanghua
 * @LastEditTime: 2024-09-26 15:15:24
-->
<template>
  <div class="demo-home2">
    <el-button type="primary" @click="goHomePage">back</el-button>
    <hr />
    <el-button type="primary" @click="createDB">创建数据库</el-button>
    <el-button type="primary" @click="deleteDB">删除数据库</el-button>
    <el-button type="primary" @click="createObject">创建表对象</el-button>
    <el-button type="primary" @click="deleteObject">删除表对象</el-button>
    <hr />
...
const clientIndexeddb = new ClientIndexeddb('testDatabase', 'person', ['name', 'age'], () => {
  onSelect()
})

onMounted(() => {
  console.log(proxy.$utils.sortVersion(['1.2.3', '1.3.1', '1.0.23', '1.0.23', '2.3.1', '1.0.3']))
...
// const dbName = 'testDatabase2'
// const objectName = 'aaa'
// const clientIndexeddb2 = new ClientIndexeddb(dbName, objectName, ['a'])
function createDB() {
  // clientIndexeddb2.initDb()
}

function deleteDB() {
  // clientIndexeddb2.deleteDB()
}

function createObject() {
  // clientIndexeddb.addObject('a', ['a', 'b'])
}

function deleteObject() {
  // clientIndexeddb.deleteObject('a')
}
